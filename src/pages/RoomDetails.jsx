...
//   { id: "bodySoap", img: bodySoap, label: "Body soap", category: "Bathroom" },
//   { id: "hotWater", img: hotWater, label: "Hot water", category: "Bathroom" },
//   { id: "washerDryer", img: washerDryer, label: "Washing machine with dryer", category: "Bathroom" },
//   { id: "jacuzzi", img: jacuzzi, label: "Jacuzzi", category: "Bathroom" },
//   { id: "bath", img: bath, label: "Bath", category: "Bathroom" },
...
//     category: "Bedroom and laundry",
//   },
//   { id: "clothesStorage", img: clothesStorage, label: "Clothes storage", category: "Bedroom and laundry" },
//   { id: "hangers", img: hangers, label: "Hangers", category: "Bedroom and laundry" },

//   { id: "wifi", img: wifi, label: "Wifi", category: "Entertainment" },
//   { id: "tv", img: tv, label: "TV", category: "Entertainment" },
//   { id: "ethernet", img: ethernet, label: "Ethernet", category: "Entertainment" },
//   { id: "gamesConsole", img: gamesConsole, label: "Games console", category: "Entertainment" },
//   { id: "books", img: books, label: "Books and reading material", category: "Entertainment" },
//   { id: "outdoorPlayground", img: outdoorPlayground, label: "Outdoor playground", category: "Entertainment" },

//   { id: "smokeAlarm", img: smokeAlarm, label: "Smoke alarm", category: "Home safety" },
//   { id: "carbonAlarm", img: carbonAlarm, label: "Carbon monoxide alarm", category: "Home safety" },
//   { id: "securityCamera", img: securityCamera, label: "Exterior security cameras on property", category: "Home safety" },
//   { id: "fireExtinguisher", img: fireExtinguisher, label: "Fire extinguisher", category: "Home safety" },
//   { id: "firstAidKit", img: firstAidKit, label: "First aid kit", category: "Home safety" },
//   { id: "security247", img: security247, label: "24/7 Security", category: "Home safety" },

//   { id: "ac", img: ac, label: "Air conditioning", category: "Heating and cooling" },
//   { id: "heater", img: heater, label: "Heater", category: "Heating and cooling" },

//   { id: "kitchen", img: kitchen, label: "Kitchen", category: "Kitchen & dining" },
//   { id: "fridge", img: fridge, label: "Fridge", category: "Kitchen & dining" },
//   { id: "microwave", img: microwave, label: "Microwave", category: "Kitchen & dining" },
//   { id: "cookingBasics", img: cookingBasics, label: "Cooking basics (Pots, pans etc.)", category: "Kitchen & dining" },
//   { id: "dishesCutlery", img: dishesCutlery, label: "Dishes and cutlery", category: "Kitchen & dining" },
//   { id: "cooker", img: cooker, label: "Cooker", category: "Kitchen & dining" },
//   { id: "kettle", img: kettle, label: "Kettle", category: "Kitchen & dining" },
//   { id: "coffeeMaker", img: coffeeMaker, label: "Coffee maker: Nespresso", category: "Kitchen & dining" },
//   { id: "freezer", img: freezer, label: "Freezer", category: "Kitchen & dining" },
//   { id: "oven", img: oven, label: "Oven", category: "Kitchen & dining" },
//   { id: "dishwasher", img: dishwasher, label: "Dishwasher", category: "Kitchen & dining" },
//   { id: "toaster", img: toaster, label: "Toaster", category: "Kitchen & dining" },
//   { id: "wineGlasses", img: wineGlasses, label: "Wine glasses", category: "Kitchen & dining" },
//   { id: "liquor", img: liquor, label: "Liquor", category: "Kitchen & dining" },
//   { id: "diningTable", img: diningTable, label: "Dining table", category: "Kitchen & dining" },
//   { id: "wipes", img: wipes, label: "Wipes / tissues", category: "Kitchen & dining" },

//   { id: "freeParking", img: freeParking, label: "Free parking on premises", category: "Facilities" },
//   { id: "paidParking", img: paidParking, label: "Paid parking off premises", category: "Facilities" },
//   { id: "sauna", img: sauna, label: "Sauna", category: "Facilities" },
//   { id: "bbq", img: bbq, label: "BBQ machine", category: "Facilities" },
//   { id: "lift", img: lift, label: "Lift", category: "Facilities" },
//   { id: "gym", img: gym, label: "Gym", category: "Facilities" },
//   { id: "workspace", img: workspace, label: "Dedicated workspace", category: "Facilities" },

//   { id: "resortAccess", img: resortAccess, label: "Resort access", category: "Outdoor" },
//   { id: "outdoorDining", img: outdoorDining, label: "Outdoor dining area", category: "Outdoor" },
//   { id: "pool", img: pool, label: "Pool", category: "Outdoor" },

//   { id: "selfCheckService", img: selfCheckService, label: "Self check-in", category: "Services" },
//   { id: "cleaning", img: cleaning, label: "Cleaning available during stay", category: "Services" },
//   { id: "lockbox", img: lockbox, label: "Lockbox", category: "Services" },
...
//   // ✅ FIX #1: Fetch room by ID (NOT bookings route)
//   useEffect(() => {
//     if (!id) {
//       setRoomError("Room id is missing from URL.");
//       setLoadingRoom(false);
...
//         // support both response shapes: { room } OR direct room object
...
//   const fallbackPricePerNight = 80;
//   const rawPriceFromRoom =
//     room?.basePricePerNight ?? room?.pricePerNight ?? room?.basePrice ?? room?.nightlyRate ?? fallbackPricePerNight;

//   const pricePerNight =
//     typeof rawPriceFromRoom === "number" ? rawPriceFromRoom : Number(rawPriceFromRoom) || fallbackPricePerNight;
...
//   // ----- Derived UI data from room -----
//   const mainImage = room?.coverImage || room1;
//   const galleryImages = room?.galleryImages && room.galleryImages.length > 0 ? room.galleryImages : [room2, room3, room4, room5];
...
//   const roomTypeLabel =
//     room?.roomTypeLabel && room.roomTypeLabel.trim() !== "" ? room.roomTypeLabel : "Studio, Apartment, Private room";

//   const maxGuests = room?.maxGuests ?? room?.guests ?? room?.capacity ?? 3;
//   const bedCount = room?.beds ?? room?.bedCount ?? 1;
//   const bathCount = room?.baths ?? room?.bathCount ?? 1;
...
//     return (
//       <div className="bg-[#f3f8fe] min-h-screen">
//         <div className="max-w-[1280px] mx-auto px-6 pt-10 text-sm text-gray-700">Loading room…</div>
//       </div>
//     );
//   }
...
//     return (
//       <div className="bg-[#f3f8fe] min-h-screen">
//         <div className="max-w-[1280px] mx-auto px-6 pt-10 text-sm text-red-600">{roomError || "Failed to load room details."}</div>
//       </div>
//     );
//   }
...
//             <div className="col-span-2">
//               <div className="w-full h-[360px] rounded-xl overflow-hidden bg-gray-100">
//                 <img src={mainImage} alt="room main" className="w-full h-full object-cover object-center" />
//               </div>
//             </div>
//             <div className="grid grid-cols-2 gap-2 h-[360px]">
//               {galleryImages.slice(0, 4).map((img, i) => (
//                 <div key={i} className="w-full h-full rounded-xl overflow-hidden bg-gray-100">
//                   <img src={img} alt={`room ${i + 2}`} className="w-full h-full object-cover object-center" />
//                 </div>
//               ))}
//             </div>
//           </div>
...
//           {/* MAIN TWO-COLUMN LAYOUT */}
//           <div className="flex flex-col lg:flex-row gap-10 mt-10" style={{ marginTop: "15px" }}>
//             {/* LEFT COLUMN */}
//             <div className="flex-1 min-w-0">
//               <p className="text-[20px] mb-2 font-medium">{headlineText}</p>
//               <p className="text-sm mb-4 text-gray-700">{configLine}</p>
...
//                 <div>
//                   <p className="text-sm font-medium leading-4">Hosted by {hostName}</p>
//                   <p className="text-xs text-gray-600">{hostYearsHosting} years hosting</p>
//                 </div>
//               </div>
...
//               <div className="space-y-4 text-sm mb-8">
//                 {selectedHighlights.map((perk, i) => {
//                   const title = perk.id === "superhost" ? `${hostName} is a Superhost` : perk.title;
//                   return (
//                     <div key={i} className="flex items-start gap-4">
//                       <img src={perk.img} alt={title} className="h-6 w-6 mt-1" />
//                       <div>
//                         <p className="font-medium text-[15px]">{title}</p>
//                         <p className="text-gray-600 text-[14px]">{perk.desc}</p>
//                       </div>
//                     </div>
//                   );
//                 })}
...
//               {/* RATINGS + REVIEWS + HOST sections remain exactly as your original */}
//               {/* (Keeping them unchanged to avoid breaking your pixel-perfect UI) */}
...
//                 <div className="border-r px-3 py-2">
//                   <p className="text-[11px] font-semibold mb-[2px]">CHECK-IN</p>
//                   <p className="text-[14px]">{checkInDate ? dayjs(checkInDate).format("MM/DD/YYYY") : "Add date"}</p>
//                 </div>
//                 <div
//                   className="px-3 py-2"
//                   onClick={(e) => {
...
//                   }}
//                 >
//                   <p className="text-[11px] font-semibold mb-[2px]">CHECK-OUT</p>
//                   <p className="text-[14px]">{checkOutDate ? dayjs(checkOutDate).format("MM/DD/YYYY") : "Add date"}</p>
//                 </div>
//               </div>
...
//                       setCheckInDate(checkIn);
//                       setCheckOutDate(null);
//                     } else if (activeField === "checkOut" && checkInDate && checkOut && dayjs(checkOut).isAfter(checkInDate)) {
//                       setCheckOutDate(checkOut);
//                     }
//                     if (checkIn && checkOut) {
//                       setCheckInDate(checkIn);
...
//                       { key: "pets", label: "Pets", desc: "" },
//                     ].map(({ key, label, desc }) => (
//                       <div key={key} className="flex justify-between items-center mb-3">
//                         <div>
//                           <p className="font-semibold text-[15px] leading-4">{label}</p>
//                           {desc && <p className="text-[13px] text-gray-500">{desc}</p>}
//                         </div>
//                         <div className="flex items-center gap-3">
//                           <button
//                             onClick={(e) => {
...
//                             }}
//                           >
//                             <img src={minusIcon} alt="-" className="w-6 h-6" />
//                           </button>
//                           <span className="w-4 text-center text-[15px]">{guests[key]}</span>
//                           <button
//                             onClick={(e) => {
//                               e.stopPropagation();
//                               updateGuestCount(key, 1);
...
//                     const parts = [];
//                     if (guests.adults) parts.push(`${guests.adults} guest${guests.adults > 1 ? "s" : ""}`);
...
//                 className="mt-4 w-full py-2 text-white text-[15px] font-semibold rounded-md transition bg-[#FF5A5F] hover:bg-[#e04141] disabled:opacity-60 disabled:cursor-not-allowed"
//               >
//                 {checkInDate && checkOutDate && areDatesAvailable() ? "Reserve" : "Check availability"}
//               </button>

//               <p className="text-[13px] text-gray-500 text-center mt-2">You won’t be charged yet.</p>
//             </div>
//           </div>
//         </div>
//       </div>
...
// ✅ Build image url for backend "uploads/xxx.jpg"
...
const HIGHLIGHT_CONFIG = [
  { id: "selfCheck", img: perkCheckin, title: "Self Check-in", desc: "Check yourself in with the lockbox." },
  { id: "parkFree", img: perkPark, title: "Park for free", desc: "This is one of the few places in the area with free parking." },
  { id: "superhost", img: perkSuperhost, title: "Superhost", desc: "Superhosts are experienced, highly rated Hosts." },
  { id: "outdoorEntertainment", img: perkOutdoor, title: "Outdoor entertainment", desc: "The pool and outdoor seating are great for summer trips." },
];
...
const AMENITY_CONFIG = [
  ...
  { id: "essentials", img: essentials, label: "Essentials (Towels, bed sheets etc.)", category: "Bedroom and laundry" },
  { id: "extraPillows", img: extraPillows, label: "Extra pillows and blankets", category: "Bedroom and laundry" },
  { id: "iron", img: iron, label: "Iron", category: "Bedroom and laundry" },
  { id: "miniFridge", img: miniFridge, label: "Mini fridge with mini bar", category: "Bedroom and laundry" },
  { id: "clothesStorage", img: clothesStorage, label: "Clothes storage", category: "Bedroom and laundry" },
  { id: "hangers", img: hangers, label: "Hangers", category: "Bedroom and laundry" },
...
const RoomDetails = () => {
  ...
  useEffect(() => {
    ...
    const fetchRoomBookings = async () => {
      try {
        ...
        bookings.forEach((b) => {
          const start = dayjs(b.checkIn).startOf("day");
          const end = dayjs(b.checkOut).startOf("day"); // checkout is NOT booked day
          let current = start;
  ...
  const updateGuestCount = (type, increment) => {
    setGuests((prev) => {
      const next = (prev[type] || 0) + increment;
  ...
  const totalNights =
    checkInDate && checkOutDate ? dayjs(checkOutDate).diff(dayjs(checkInDate), "day") : 0;
  ...
  const areDatesAvailable = () => {
    ...
    let day = dayjs(checkInDate).startOf("day");
  ...
  if (loadingRoom) {
    return (
      <div className="bg-[#f3f8fe] min-h-screen">
        <div className="max-w-[1280px] mx-auto px-4 md:px-6 pt-6 pb-20">
          {/* Title skeleton */}
          <div className="h-6 w-[60%] bg-gray-200 rounded-md mb-4 animate-pulse" />

          {/* Hero image skeleton */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-2 mb-6 animate-pulse">
            <div className="md:col-span-2">
              <div className="w-full h-[220px] md:h-[360px] rounded-xl bg-gray-200" />
            </div>
            <div className="hidden md:grid grid-cols-2 gap-2 h-[360px]">
              {[0, 1, 2, 3].map((i) => (
                <div key={i} className="rounded-xl bg-gray-200" />
              ))}
            </div>
          </div>
          ...
          <div className="flex flex-col lg:flex-row gap-10 mt-4">
            ...
            <div className="flex-1 min-w-0 space-y-4 animate-pulse">
              ...
              <div className="space-y-3 mt-6">
                {[0, 1, 2, 3].map((i) => (
                  <div key={i} className="flex items-start gap-4">
                    <div className="h-6 w-6 rounded bg-gray-200 flex-shrink-0" />
                    <div className="space-y-1 flex-1">
                      <div className="h-3.5 w-[50%] bg-gray-200 rounded" />
            ...
            <div className="w-full lg:w-[320px] animate-pulse">
              <div className="p-5 rounded-xl bg-white shadow-lg space-y-3">
                ...
                <div className="border rounded-md px-3 py-3 space-y-1">
                ...
                <div className="h-3 w-[60%] bg-gray-100 rounded mx-auto" />
              </div>
            </div>
          </div>
        </div>
              ...
              {galleryImages.slice(0, 4).map((img, i) => (
                <div key={i} className="w-full h-full rounded-xl overflow-hidden bg-gray-100">
                  <img
                    ...
                    alt={`room ${i + 2}`}
                    className="w-full h-full object-cover object-center"
                    onError={(e) => (e.currentTarget.src = [room2, room3, room4, room5][i] || room2)}
                  />
                </div>
              ))}
            </div>
